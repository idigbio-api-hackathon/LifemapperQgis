...
from lifemapperTools.common.lmListModel import LmListModel, BackSpaceEventHandler, EnterTextEventHandler
...
# ........................................................................      
   def setEventHandlers(self):
      ...
      self.findCladeCombo.installEventFilter(self.BackSpaceEvent)
   ...
   def searchJSON(self,text):
      ...
      if len(matchingDicts) > 0:
         items = [TreeSearchResult(d['name'],'','',d["path"]) for d in matchingDicts]
      else:
         items = [TreeSearchResult('','','','')]
      self.leafHintModel.updateList(items)
   ...
   def onTextChange(self, text):
      ...
      if noChars >= 3:
         currentIdx = self.findCladeCombo.currentIndex()
         if currentIdx == -1:
            self.findCladeCombo.setCurrentIndex(0)
         currentIdx = self.findCladeCombo.currentIndex()
         try:
