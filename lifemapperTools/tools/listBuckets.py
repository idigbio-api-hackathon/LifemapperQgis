...
# ..............................................................................
   def getShapeFile_deprecated(self, status, model, fromIntersect=True): 
   ...
   def addtoTable(self,items,model,currentPage):
      ...
      try: 
         ...
         for o in items:
            ...
            data.append([o.name,int(o.id),stagestring,statusstring,"<a href='"+str(o.id)+"'>Get Grid</a>",o.status,shapegrid])
