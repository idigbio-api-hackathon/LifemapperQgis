...
from LmCommon.common.lmconstants import URL_ESCAPES, \
         BISON_OCCURRENCE_URL, BISON_MAX_POINT_COUNT, BISON_QFILTERS, BISON_FILTERS, \
         BISON_TSN_FILTERS, BISON_OCC_FILTERS, BISON_TSN_KEY, BISON_TSN_LIST_KEYS, \
         BISON_HIERARCHY_KEY, BISON_NAME_KEY, BISON_KINGDOM_KEY, \
         BISON_RESPONSE_FIELDS, BISON_COUNT_KEYS, BISON_RECORD_KEYS, \
         ITIS_TAXONOMY_HIERARCHY_URL, ITIS_TAXONOMY_KEY, ITIS_HIERARCHY_TAG, \
         ITIS_RANK_TAG, ITIS_TAXON_TAG, ITIS_KINGDOM_KEY, \
         ITIS_PHYLUM_DIVISION_KEY, ITIS_CLASS_KEY, ITIS_ORDER_KEY, \
         ITIS_FAMILY_KEY, ITIS_GENUS_KEY, ITIS_SPECIES_KEY, ITIS_DATA_NAMESPACE, \
         GBIF_ORGANIZATION_SERVICE, GBIF_REST_URL, GBIF_SPECIES_SERVICE, \
         GBIF_OCCURRENCE_SERVICE, GBIF_DATASET_SERVICE, \
         IDIGBIO_OCCURRENCE_URL, IDIGBIO_SEARCH_QUERY_KEY, IDIGBIO_AGG_SPECIES_GEO_MIN_40, \
         IDIGBIO_SPECIMENS_BY_BINOMIAL, IDIGBIO_QFILTERS, IDIGBIO_FILTERS, \
         IDIGBIO_BINOMIAL_KEYS, IDIGBIO_BINOMIAL_REGEX 
...
# ...............................................
   def getBinomial(self):
      ...
      for entry in dataList:
         matches = re.match(BINOMIAL_REGEX, entry[IDIGBIO_NAME_KEY])
         if matches:
